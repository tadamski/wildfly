...
public class EjbDependencyDeploymentUnitProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        // add custom interceptors dependencies
        ...
        if (ejbJarMetaData != null && ejbJarMetaData.getAssemblyDescriptor() != null) {
            ...
            if (metaData != null) {
                for (AOPMetaData md : metaData) {
                    moduleSpecification.addSystemDependency(new ModuleDependency(moduleLoader, ModuleIdentifier.create(md.getInterceptorModule()), false, false, false, true));
                }
            }
        }
    }
