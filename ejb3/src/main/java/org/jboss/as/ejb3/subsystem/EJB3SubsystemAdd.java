        ...
        context.addStep(new AbstractDeploymentChainStep() {
            ...
            protected void execute(DeploymentProcessorTarget processorTarget) {
                ...
                if (!appclient) {
                    ...
                    processorTarget.addDeploymentProcessor(EJB3Extension.SUBSYSTEM_NAME, Phase.POST_MODULE, Phase.POST_MODULE_EJB_SERVER_INTERCEPTORS, new ContainerInterceptorBindingsDDProcessor());
