...
public class StressTestManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation {
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo cxRequestInfo) throws ResourceException {
        ...
        StressTestManagedConnection mc = new StressTestManagedConnection(this, cm);
        new RandomDestroyerThread(mc).start();
        return mc;
    }
    ...
    private class RandomDestroyerThread extends Thread {

        private StressTestManagedConnection mc;

        public RandomDestroyerThread(StressTestManagedConnection mc){
            super("Destroyer");
            this.mc = mc;
        }
