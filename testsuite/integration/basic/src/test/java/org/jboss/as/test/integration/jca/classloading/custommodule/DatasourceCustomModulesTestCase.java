...
public class DatasourceCustomModulesTestCase {
    ...
    public void test() throws Exception {
        ...
        CustomExceptionSorter.reset();
        CustomStaleConnectionSorter.reset();
        ...
        Assert.assertTrue(CustomValidator.wasInvoked());
        Assert.assertTrue(CustomExceptionSorter.wasInvoked());
        Assert.assertTrue(CustomStaleConnectionSorter.wasInvoked());
    ...
    public void createDatasource() throws Exception {
        ...
        createDsOp.get("valid-connection-checker-class-name").set("org.jboss.as.test.integration.jca.classloading.custommodule.CustomValidator");
        createDsOp.get("valid-connection-checker-module").set("org.jboss.test.customModule");
        createDsOp.get("exception-sorter-class-name").set(CustomExceptionSorter.class.getName());
        createDsOp.get("exception-sorter-module").set("org.jboss.test.customModule");
        createDsOp.get("stale-connection-checker-class-name").set(CustomStaleConnectionSorter.class.getName());
    ...
    public static class Setup implements ServerSetupTask {
        ...
        public static JavaArchive getDeployment() {
            ...
            jar.addClass(CustomValidator.class);
            jar.addClass(CustomExceptionSorter.class);
            jar.addClass(CustomStaleConnectionSorter.class);
            return jar;
        }
