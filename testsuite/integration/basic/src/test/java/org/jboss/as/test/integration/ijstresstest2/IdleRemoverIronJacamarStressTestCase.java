...
import org.jboss.as.test.integration.ijstresstest2.ejb.StressEJB;
import org.jboss.as.test.integration.ijstresstest2.ejb.StressEJBBean;
...
@ServerSetup(IdleRemoverIronJacamarStressTestCase.IronJacamarStressTestCaseSetup.class)
public class IdleRemoverIronJacamarStressTestCase {
    ...
    public static Archive deployEjb() {
        ...
        ejbJar.addAsManifestResource(IdleRemoverIronJacamarStressTestCase.class.getPackage(), "MANIFEST.MF", "MANIFEST.MF");
        return ejbJar;
    }
