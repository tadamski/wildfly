...
@ServerSetup(IronJacamarDisassociationStressTestCase.IronJacamarStressTestCaseSetup.class)
public class IronJacamarDisassociationStressTestCase {

    static class IronJacamarStressTestCaseSetup extends AbstractMgmtServerSetupTask {

        @Override
        public void doSetup(final ManagementClient managementClient) throws Exception {
            String xml = FileUtils.readFile(IronJacamarDisassociationStressTestCase.class, "ra-subsystem.xml");
    ...
    public static Archive deployEjb() {
        ...
        ejbJar.addAsManifestResource(IronJacamarDisassociationStressTestCase.class.getPackage(), "MANIFEST.MF", "MANIFEST.MF");
        return ejbJar;
    }
